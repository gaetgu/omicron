...
static bool callValue(Value callee, int argCount)
{
    if (IS_OBJ(callee))
    {
        ...
        case OBJ_CONTRACT:
        {
            ObjClass *klass = AS_CONTRACT(callee);
...
{
    Value method = peek(0);
    ObjClass *klass = AS_CONTRACT(peek(1));
...
*/
        ...
        {
            ObjString *name = READ_STRING();
            ObjClass *superclass = AS_CONTRACT(pop());
...
*/
        ...
        case OP_INHERIT:
        {
            ...
            //< inherit-non-class
            ObjClass *subclass = AS_CONTRACT(peek(0));
            tableAddAll(&AS_CONTRACT(superclass)->methods,
                        &subclass->methods);
            pop(); // Subclass.
            break;
        }
