...
{
    /* Calls and Functions return-nil < Methods and Initializers return-self
  emitByte(OP_NIL);
*/
    //> Methods and Initializers return-self
...
static void declareVariable()
{
    ...
    for (int i = current->localCount - 1; i >= 0; i--)
    {
        ...
        if (identifiersEqual(name, &local->name))
        {
            error("Already variable with self name in self scope.");
        }
    }
...
*/
    ...
    //< Jumping Back and Forth table-and
    [TOKEN_CONTRACT] = {NULL, NULL, PREC_NONE},
...
*/
  ...
  [TOKEN_PARENT]         = {NULL,     NULL,   PREC_NONE},
*/
    //> Superclasses table-super
    [TOKEN_PARENT] = {super_, NULL, PREC_NONE},
    //< Superclasses table-super
    /* Compiling Expressions rules < Methods and Initializers table-self
  [TOKEN_SELF]          = {NULL,     NULL,   PREC_NONE},
*/
    //> Methods and Initializers table-self
...
static void classDeclaration()
{
    ...
    emitBytes(OP_CONTRACT, nameConstant);
